...
const breakpoints = [
  {
    width: 430,
    sizes: [400, 300, 300, 200, 250, 200],
    speeds: [0.1, 0.2, 0.3, 0.5, 0.4, 0.3],
  },
  {
    width: 768,
    sizes: [550, 500, 400, 450, 300, 300],
    speeds: [0.1, 0.2, 0.4, 0.5, 0.6, 0.7],
  },
  {
    width: 1024,
    sizes: [600, 650, 600, 600, 350, 300],
    speeds: [0.2, 0.3, 0.5, 0.6, 0.7, 0.7],
  },
  {
    width: 1440,
    sizes: [900, 800, 700, 500, 300, 300],
    speeds: [0.2, 0.5, 0.8, 0.7, 1, 1],
  },
  {
    width: Infinity,
    sizes: [900, 800, 700, 600, 400, 300],
    speeds: [0.3, 0.2, 0.8, 0.7, 1.1, 1.2],
  },
];
...
//   {
//     width: 1440,
//     sizes: [500, 300, 700, 700, 900, 1000],
//     speeds: [1.5, 0.8, 1.6, 0.5, 0.2, 0.3],
//   },
//   {
//     width: Infinity,
//     sizes: [800, 300, 900, 900, 600, 1000],
//     speeds: [1.5, 0.8, 1.6, 0.5, 0.2, 0.3],
//   },
// ];
